...
<li>
  ...
  <a
    ...
    target="_blank"
    rel="noopener"
    class="text-base mt-5 px-10 py-3 rounded-md bg-secondary text-text font-bold hover:bg-hoverButton transition-colors duration-200 ease-in-out"
  >
    Запись
  </a>
</li>
