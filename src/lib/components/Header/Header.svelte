...
<header class="mt-3 mb-10 mx-auto max-w-[1440px] bg-background h-[80px] flex justify-between items-center sm:gap-8 md:gap-12 flex-grow">
    ...
    <div class="flex pt-2  items-center mx-auto justify-center flex-grow">
        ...
        <div class=" leading-normal min-w-[100px] max-h-[100px]">
        ...
        <div class="flex flex-col pt-1 items-start gap-1 pr-10 lg:flex-row lg:items-center lg:pr-10 lg:gap-3">
...
<div class="mx-auto max-w-[1440px] bg-third">
  <div class=" flex flex-grow mx-auto justify-center items-center">
    ...
    <div class="dropdown dropdown-hover ">
      ...
      <ul  class="dropdown-content menu bg-background  z-10 w-36 items-center rounded-box">
    ...
    <div class="dropdown dropdown-hover">
      ...
      <ul  class="dropdown-content menu bg-base-100  z-10 w-36 items-center text-second rounded-box">
        <li><a href="/">сервис</a></li>
        <li><a href="/">сервис</a></li>
        <li><a href="/">сервис</a></li>
        <li><a href="/">сервис</a></li>
    ...
    <div class="dropdown dropdown-hover ">
      ...
      <ul  class="dropdown-content menu bg-base-100  z-10 w-36 items-center text-second text-left rounded-box">
        <li><a href="/">Сервисные работы</a></li>
        <li><a href="/">Замена масел</a></li>
        <li><a href="/">Регулировка света фар</a></li>
        <li><a href="/">Аппаратная замена антифриза</a></li>
      </ul>
